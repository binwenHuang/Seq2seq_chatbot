# Zakaria Daud Graduate Seq2seq chatbot project graph_Utils.py
...
# Function to convert output from numbers to text and print it
...
# Function to calculate prediction from saved model given input sequence
